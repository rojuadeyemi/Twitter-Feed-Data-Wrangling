...
Using Python and its libraries (pandas, numpy, matplotlib, etc), I gathered data from a variety of sources and in a variety of formats, assessed its quality and tidiness, then cleaned it. I also analyzed and visualized the cleaned data using Python [Wrangle Report](https://rojuadeyemi.github.io/Twitter-Feed-Data-Wrangling/)
